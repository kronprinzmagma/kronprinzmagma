...
AI Product Practitioner – building production AI applications with Claude, GPT, and local models. Multi-agent systems, privacy-first hybrid architectures, agentic coding with Claude Code and Codex.

Senior Product Owner with 19+ years in digital products. Localina founder (acquired by local.ch). Currently positioned at the intersection of AI Product Management and AI Engineering.
